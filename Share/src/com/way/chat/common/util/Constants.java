...
public class Constants {
	...
	public static final String ACTION = "com.kids.message";// ��Ϣ�㲥action
	public static final String MSGKEY = "message";// ��Ϣ��key
	public static final String PICUPDATE = "pictureupdate";// ��Ϣ��key
	public static final String IP_PORT = "ipPort";// ����ip��port��xml�ļ���
	public static final String SAVE_USER = "saveUser";// �����û���Ϣ��xml�ļ���
	public static final String BACKKEY_ACTION = "com.kids.backKey";// ���ؼ����͹㲥��action
	public static final int NOTIFY_ID = 0x911;// ֪ͨID
	public static final String DBNAME = "kids.db";// ���ݿ�����
